export const APP_COLOR = {
  ...
  DARK_YELLOW: "rgba(248, 169, 31, 0.4)",
  BACKGROUND_ORANGE: "#FFF5F0",
  PROCESSING: "F8A91F",
  DONE: "#1A3F22",
  CANCEL: "#D71616",
...
export const BASE_URL = "https://tam-tac.com/api/v1";
export const GOOGLE_API_KEY = "AIzaSyDG_BzswCLO3QGtZWQ0sZet9mfv3ZmUB2I";
