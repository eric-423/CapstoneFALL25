...
public class ProductController {
        ...
        public ResponseEntity<PagedResponse<ProductSearchDTO>> searchProducts(
                        ...
                        @Parameter(description = "Trường sắp xếp", example = "name", schema = @Schema(allowableValues = {
                                        "name",
                                        "price", "createdDate",
                                        "productType" })) @RequestParam(required = false, defaultValue = "name") String sortBy,

                        @Parameter(description = "Hướng sắp xếp", example = "ASC", schema = @Schema(allowableValues = {
                                        "ASC",
