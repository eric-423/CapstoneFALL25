...
CREATE TABLE `cart_items` (
  ...
  `note` text,
  PRIMARY KEY (`cart_id`),
  KEY `FK74jcyp1082780w45aowyndsdg` (`combo_id`),
  ...
  CONSTRAINT `FK74jcyp1082780w45aowyndsdg` FOREIGN KEY (`combo_id`) REFERENCES `combo` (`id`),
  CONSTRAINT `FKl7je3auqyq1raj52qmwrgih8x` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`)
