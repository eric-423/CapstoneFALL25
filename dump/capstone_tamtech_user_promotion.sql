...
INSERT INTO `user_promotion` VALUES
  (1,17,'2025-12-24 00:00:00.000000',NULL,UNHEX(REPLACE('00000000-0000-0000-0000-000000000001','-','')),NULL,'AVAILABLE'),
  (1,17,'2025-12-24 00:00:00.000000',NULL,UNHEX(REPLACE('00000000-0000-0000-0000-000000000002','-','')),NULL,'AVAILABLE'),
  (1,17,'2025-12-24 00:00:00.000000',NULL,UNHEX(REPLACE('00000000-0000-0000-0000-000000000003','-','')),NULL,'AVAILABLE');
