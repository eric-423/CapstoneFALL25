...
CREATE TABLE `combo_item` (
  ...
  `note` text,
  PRIMARY KEY (`id`),
  KEY `FK8163lac8tty6571u6ensdpwr8` (`combo_id`),
  KEY `FK4ge3twm5tdeijqahqqxf4h9ob` (`product_id`),
  CONSTRAINT `FK4ge3twm5tdeijqahqqxf4h9ob` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`),
  CONSTRAINT `FK8163lac8tty6571u6ensdpwr8` FOREIGN KEY (`combo_id`) REFERENCES `combo` (`id`)
