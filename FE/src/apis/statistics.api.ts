...
export async function getOrderCountStatistics(branchId: number, date?: string) {
    ...
    const response = await fetch(`/api/statistics/order-count?${params.toString()}`, {
        method: 'GET',
        credentials: 'include',
    });
 ...
 */
export async function getNewCustomerStatistics(comparisonType: 'DAILY' | 'MONTHLY' = 'DAILY') {
    const params = new URLSearchParams({ comparisonType });

    const response = await fetch(`/api/statistics/new-customers?${params.toString()}`, {
        method: 'GET',
        credentials: 'include',
    });
...
export async function getServiceTimeStatistics(
    ...
    const response = await fetch(`/api/statistics/service-time?${params.toString()}`, {
        method: 'GET',
        credentials: 'include',
    });
...
export async function getRevenue7Days(branchId?: number) {
    ...
    const response = await fetch(`/api/statistics/revenue-7days?${params.toString()}`, {
        method: 'GET',
        credentials: 'include',
    });
...
export async function getTopMaterials(branchId?: number, limit: number = 5) {
    ...
    const response = await fetch(`/api/statistics/top-materials?${params.toString()}`, {
        method: 'GET',
        credentials: 'include',
    });
...
export async function getTopSellingItems(branchId?: number, limit: number = 5): Promise<TopSellingItems> {
    ...
    const response = await fetch(`/api/statistics/top-selling?${params.toString()}`, {
        method: 'GET',
        credentials: 'include',
    });
