...
export const signUp = async (phoneNumber: string) => {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/customer/sign-up`,
    {
      method: "POST",
...
export const sendOTP = async (phoneNumber: string) => {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/verify-code/send?mode=`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ phoneNumber }),
...
export const refetchToken = async (refresh: string) => {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/token/refresh?token=${refresh}`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    }
...
export const registerWithOTP = async (data: RegisterData, otp: string) => {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/customer/register`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export const sendRegistrationOTP = async (phoneNumber: string) => {
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/verify-code/send`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export const signIn = async (data: {
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/customer/sign-in`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
export const changePassword = async (userId: number, newPassword: string) => {
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/auth/customer/change-password/${userId}`,
    {
      method: "POST",
      headers: {
...
export const createUser = async (
  ...
  const fetchResponse = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/users/admin/create`,
    {
      method: "POST",
      headers: {
...
export const updateUser = async (
  ...
  const token = localStorage.getItem("access_token");
  const fetchResponse = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/users/admin/update/${userId}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export const getUserDetail = async (userId: number) => {
  const token = localStorage.getItem("access_token");
  const fetchResponse = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/users/admin/detail/${userId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const unbanUser = async (userId: number) => {
  const token = localStorage.getItem("access_token");
  const fetchResponse = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/users/admin/unban/${userId}`,
    {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
...
export const registerCustomer = async (data: {
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/auth/customer/register`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
...
export const getTimeResendOtp = async (
  ...
  const response = await fetch(
    `${process.env.NEXT_PUBLIC_BASE_URL}/auth/otp/ttl?${params.toString()}`,
    {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    }
...
export const deleteCustomerInformation = async (
  ...
  if (!response.ok) {
    ...
    throw {
      response: {
        data: parsed ?? { error: rawBody || "Unknown error" },
        status: response.status,
      },
    };
  }
  ...
  return parsed ?? { success: true, message: "Xóa thành công" };
};
