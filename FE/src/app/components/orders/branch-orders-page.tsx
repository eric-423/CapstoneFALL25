...
const getStatusLabel = (status: string, pickUp?: boolean): string => {
  ...
  if (pickUp && (status === "SHIPPING" || status === "DELIVERING")) {
  ...
  return (
    <>
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            ...
                            >
                              ...
                              {getStatusLabel(order.orderStatus, order.pickUp)}
                            </Badge>
                          </td>
                          <td className="px-4 py-3">
      ...
      {isStaff && (
        ...
        >
          <DialogContent className="w-[90vw] sm:w-[90vw] lg:w-[50vw] max-w-[95vw] sm:max-w-5xl lg:max-w-6xl max-h-[90vh] overflow-y-auto bg-[#FFF9F3] rounded-3xl border-none p-4 sm:p-6 shadow-[0_20px_50px_rgba(12,21,55,0.2)] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {detailLoading && (
                ...
                <DialogHeader>
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(selectedOrder.isTable || selectedOrder.table) && (
