...
interface AddressManagementSectionProps {
  userId: number;
  onAddClickRef?: React.MutableRefObject<(() => void) | null>;
}
...
export default function AddressManagementSection({
  ...
  const [editingAddress, setEditingAddress] =
    useState<CustomerInformation | null>(null);
  ...
  const addresses: CustomerInformation[] = Array.isArray(
  ...
  useEffect(() => {
    if (onAddClickRef) {
      onAddClickRef.current = handleAddNew;
    }
    return () => {
      if (onAddClickRef) {
        onAddClickRef.current = null;
      }
    };
  }, [onAddClickRef, handleAddNew]);
            ...
            {isLoadingAddresses ? (
              ...
              <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Nhấn &ldquo;Thêm địa chỉ mới&rdquo; để bắt đầu
                </p>
              </div>
            ) : (
        ...
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-visible p-0">
          <div className="p-6 max-h-[85vh] overflow-y-auto">
            ...
            <form
              ...
              className="space-y-4 mt-4 animate-in fade-in-0 slide-in-from-bottom-2 duration-300 delay-75"
            >
              <div>
