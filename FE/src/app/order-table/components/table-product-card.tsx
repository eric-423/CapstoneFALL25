        ...
        <div className="relative">
              ...
              <>
                ...
                {isOutOfStock && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                    <div className="bg-red-500 text-white px-4 py-2 font-bold text-sm sm:text-base shadow-lg transform rotate-[-15deg] w-[250px] text-center h-[35px] flex items-center justify-center">
                      HẾT HÀNG
                    </div>
                  </div>
                )}
          ...
          <div className="p-3 sm:p-4 space-y-2 sm:space-y-3">
            <div>
              ...
              <p
                className={`text-xs sm:text-sm line-clamp-2 mt-1 ${isOutOfStock ? "text-gray-400" : "text-gray-600"}`}
              >
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                <span
                  className={`text-base sm:text-lg font-bold ${isOutOfStock ? "text-gray-400" : "text-primary"}`}
                >
                  {product.productPrice.toLocaleString()}đ
                </span>
                {product.calories !== undefined && (
                  <span
                    className={`text-xs ${isOutOfStock ? "text-gray-400" : "text-gray-500"}`}
                  >
