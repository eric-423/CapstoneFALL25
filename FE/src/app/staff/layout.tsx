        ...
        <div className="flex relative">
          ...
          <aside
            className={`
                    ...
                    `}
          >
            <div className="p-4 sm:p-5 border-b border-white/20 flex-shrink-0 flex items-center gap-2">
              {!isCollapsed && (
                <h2 className="font-bold text-base sm:text-lg lg:text-xl text-white drop-shadow-md flex-1">
                  TamTech Staff
                </h2>
              )}
              <button
                onClick={() => setIsCollapsed((prev) => !prev)}
                className="hidden lg:flex items-center justify-center w-9 h-9 rounded-lg hover:bg-white/10 transition-colors text-white"
          ...
          <main
            className={`flex-1 w-full bg-[#EFE6DB] min-w-0 transition-[margin] duration-200 ease-out ${isCollapsed ? "lg:ml-20" : "lg:ml-56 xl:ml-64"}`}
          >
