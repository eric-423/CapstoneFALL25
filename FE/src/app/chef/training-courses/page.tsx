...
const unwrapTrainingItems = (payload: unknown): Record<string, unknown>[] => {
  ...
  if (Array.isArray(container.lessons)) {
    return container.lessons as Record<string, unknown>[];
  }
...
export default function ChefTrainingCoursesPage() {
  ...
  const { data, isLoading, isFetching, error, refetch } =
    useQuery<TrainingResponse>({
      queryKey: ["chef-training-courses", statusFilter],
      queryFn: async () =>
  ...
  return (
    <CompleteLayout title="Khóa học của tôi" icon={BookOpen}>
