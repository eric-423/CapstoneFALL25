        ...
        <div className="flex relative">
          ...
          >
            ...
            <div className="p-3 sm:p-4 flex-shrink-0 border-t border-white/20 bg-[#EC6426]">
              <Button
                className="w-full justify-start gap-3 hover:bg-[#EC6426]/90 text-white font-semibold transition-all duration-200  hover:shadow-xl py-2.5 sm:py-3 mb-2"
              ...
              <Button
                className="w-full justify-start gap-3  hover:bg-[#EC6426]/90 text-white font-semibold transition-all duration-200  hover:shadow-xl py-2.5 sm:py-3"
          ...
          <main
            className={`flex-1 w-full bg-[#EFE6DB] min-w-0 transition-[margin] duration-200 ease-out ${
              isCollapsed ? "lg:ml-20" : "lg:ml-56 xl:ml-64"
            }`}
          >
