            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-white">
                    {(recipe.totalCostPerUnit / 1000).toFixed(0)}K
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/20">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-white">
                    {recipe.nutrition.servingsPerRecipe}
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                      <span className="text-sm text-gray-600 flex items-center gap-2">
                        <span className="text-xs"></span> Danh mục
                      </span>
                    ...
                    <div className="flex justify-between items-center py-2.5 border-b border-gray-100">
                      <span className="text-sm text-gray-600 flex items-center gap-2">
                        <span className="text-xs"></span> Chuẩn bị
                      </span>
                ...
                <Card className="bg-gradient-to-br from-purple-50 to-white p-5 border-purple-100">
                  ...
                  <div className="space-y-3">
                    {recipe.tags && recipe.tags.length > 0 && (
                      <div className="py-2 border-b border-gray-100">
                        <span className="text-sm text-gray-600 block mb-2 flex items-center gap-2">
                          <span className="text-xs"></span> Tags
                        </span>
                    ...
                    {recipe.mealType && recipe.mealType.length > 0 && (
                      <div className="py-2 border-b border-gray-100">
                        <span className="text-sm text-gray-600 block mb-2 flex items-center gap-2">
                          <span className="text-xs"></span> Bữa ăn
                        </span>
                        <div className="flex flex-wrap gap-1.5">
                ...
                <Card className="bg-gradient-to-br from-green-50 to-white p-5 border-green-100">
                  ...
                  <div className="space-y-3">
                    {recipe.steps.map((step) => (
                      <div
                        key={step.stepNumber}
                        className="flex gap-3 p-3 bg-white rounded-lg border border-gray-100 hover:border-green-200 transition-colors"
                      >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">
                        Danh sách nguyên liệu và chi phí
                      </p>
                    </div>
                  </div>
                            ...
                            <div>
                              ...
                              {item.ingredientSku && (
                                <div className="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
                                  <span className="text-[10px]"></span> SKU:{" "}
                                  {item.ingredientSku}
                                </div>
                              )}
                          ...
                          <td className="px-4 py-3 text-sm">
                            <div className="flex flex-col gap-1">
                              {item.isOptional && (
                                <Badge
                                  variant="outline"
                                  className="text-xs bg-yellow-50 text-yellow-700 border-yellow-200 w-fit"
                                >
                                  Tùy chọn
                                </Badge>
                              )}
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${((recipe.suggestedPrice - recipe.totalCostPerUnit) / recipe.suggestedPrice) * 100}%`,
                              }}
                            />
                          </div>
                          <span className="font-semibold text-green-600">
            ...
            <TabsContent value="nutrition" className="mt-0 space-y-4">
                  ...
                  <div className="p-4 bg-gradient-to-br from-yellow-100 to-yellow-50 rounded-xl border border-yellow-200">
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-yellow-600">
                        {recipe.nutrition.carbsPerServing}
                        <span className="text-sm">g</span>
                      </p>
                      <p className="text-xs text-gray-600 font-medium mt-1">
                        Carbs
                  ...
                  <div className="p-4 bg-gradient-to-br from-blue-100 to-blue-50 rounded-xl border border-blue-200">
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-blue-600">
                        {recipe.nutrition.fatPerServing}
                        <span className="text-sm">g</span>
                      </p>
                      <p className="text-xs text-gray-600 font-medium mt-1">
                        Fat
                ...
                <Card className="p-5 bg-gradient-to-br from-red-50 to-white border-red-100">
                  ...
                  recipe.nutrition.allergens.length > 0 ? (
                    ...
                    <p className="text-sm text-gray-500 flex items-center gap-2">
                      <span className="text-green-600">✓</span> Không có chất
                      gây dị ứng
                    </p>
                  )}
                </Card>
              ...
              <Card className="p-5 bg-gradient-to-br from-indigo-50 to-white border-indigo-100">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="font-semibold text-gray-900">
                    Tổng dinh dưỡng (toàn bộ công thức)
                  </h3>
                </div>
                <div className="grid grid-cols-4 gap-3">
                    ...
                    {recipe.versions.map((version) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Badge
                            className={getStatusBadge(version.status).className}
                          >
