...
import { ChefHat, Plus, FileText, BookOpen, DollarSign } from "lucide-react";
...
export default function RecipesPage() {
  ...
  const stats = useMemo(
    () => ({
      ...
      avgCost: Math.round(
        MOCK_RECIPES.reduce((sum, r) => sum + r.totalCostPerUnit, 0) /
          MOCK_RECIPES.length
      ),
    }),
    []
      ...
      >
        <AdminPageLayout>
          <AdminPageHeader
            ...
            icon={ChefHat}
            actions={
              <Button className="bg-[#EC6426] hover:bg-[#EC6426]/90 text-white">
