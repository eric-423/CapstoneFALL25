          ...
          <AdminPageHeader
            ...
            actions={
              <Button
                ...
                className="bg-[#EC6426] hover:bg-[#EC6426]/90 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-semibold text-sm sm:text-base"
              >
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-[#EC6426]/30 text-[#EC6426] hover:bg-[#EC6426]/10"
                >
              ...
              {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                  {combos.map((combo) => (
                    <Card
                      key={combo.comboId}
                      className="p-4 bg-white hover:shadow-lg transition-all duration-300 border-2 border-[#EC6426]/20 hover:border-[#EC6426]"
                    >
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <span className="font-bold text-[#DA7339]">
                        ...
                        <div className="flex gap-2 pt-2 border-t">
                          <Button
                            ...
                            size="sm"
                            variant="outline"
                            className="flex-1 text-[#EC6426] border-[#EC6426]/30 hover:bg-[#EC6426]/10"
                          >
                          ...
                          <Button
                            onClick={() =>
                              handleDelete(combo.comboId, combo.name)
                            }
                            size="sm"
                            variant="outline"
