...
const printBlobInBrowser = async (blob: Blob) => {
  ...
  setTimeout(
    () => iframe.contentDocument?.readyState === "complete" && triggerPrint(),
    1500
  );
              ...
              <div className="space-y-6">
                ...
                <Card className="p-4 border border-gray-100 rounded-xl">
                  ...
                  <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between text-green-600">
                          ...
                          <span className="font-semibold">
                            {selectedOrder.discountValue === 0
                              ? "0đ"
                              : `-${formatCurrency(selectedOrder.discountValue ?? 0)}`}
                          </span>
                        </div>
                      )}
                    ...
                    {selectedOrder.pointUsed !== undefined &&
                      selectedOrder.pointUsed !== null && (
                        <div className="flex justify-between text-gray-600">
                          <span>Điểm đã dùng:</span>
                          <span className="font-semibold">
                            {selectedOrder.pointUsed === 0
                              ? "0 điểm"
                              : `-${selectedOrder.pointUsed.toLocaleString("vi-VN")} điểm`}
                          </span>
                        </div>
                      )}
                        ...
                        <div className="flex justify-between text-green-600">
                          ...
                          <span className="font-semibold">
                            {selectedOrder.pointEarned === 0
                              ? "0 điểm"
                              : `+${selectedOrder.pointEarned.toLocaleString("vi-VN")} điểm`}
                          </span>
                        </div>
                      )}
