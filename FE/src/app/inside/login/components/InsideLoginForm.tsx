...
export default function InsideLoginForm() {
  ...
  const handleVerifyOtp = async (value?: string) => {
    ...
    try {
      ...
      setOtpFeedback({
        type: "success",
        text: "Xác thực email thành công. Đang đăng nhập...",
      });
          ...
          <div className="relative z-10 flex flex-col justify-between p-12 text-white">
            <div>
              ...
              <p className="mt-4 text-base leading-relaxed text-gray-100">
                Cổng đăng nhập dành cho Admin, Quản lý và nhân viên hậu cần. Đảm
                bảo thông tin vận hành luôn chính xác và đồng bộ.
              </p>
            </div>
            <div className="space-y-4 text-sm text-gray-200">
              <div>
                ...
                <p>
                  Liên hệ phòng IT nếu bạn cần cấp lại mật khẩu hoặc gặp sự cố
                  truy cập.
                </p>
              </div>
              <div>
                ...
                <p>
                  Vui lòng không chia sẻ tài khoản nội bộ và đăng xuất sau khi
                  sử dụng.
                </p>
              </div>
            </div>
