...
export async function GET(
    ...
    try {
        ...
        const url = `${process.env.NEXT_PUBLIC_BASE_URL}/cooking-method-nutrients/${cookingMethodId}/${nutrientId}`;
...
export async function PUT(
    ...
    try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/cooking-method-nutrients/${cookingMethodId}/${nutrientId}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${token}`,
