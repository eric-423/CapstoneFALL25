...
export async function GET(request: NextRequest) {
    try {
        ...
        const url = `${baseUrl}/dashboard/operations/staff-performance${queryString ? `?${queryString}` : ''}`;

        console.log('🔄 Fetching Staff Performance:', url);
        ...
        if (!response.ok) {
            ...
            try {
                ...
                errorData = { error: errorText || 'Failed to fetch staff performance' };
            }
