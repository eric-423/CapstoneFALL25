        ...
        <div className="bg-white p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Shield className="h-8 w-8 text-[#78A243]" />
              <div>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-orange hover:bg-orange text-black border-2 border-orange"
              >
                {isCreating ? (
                  <>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm font-semibold uppercase focus:ring-orange-400 "
                ...
                >
                  {editingId === role.id ? (
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex items-center gap-2 p-2 bg-orange-50 rounded-lg border-2 border-orange-200">
                        <input
                          ...
                          onChange={(e) =>
                            setEditingIsInternal(e.target.checked)
                          }
                          className="w-4 h-4 rounded border-2 border-orange-400 text-orange-500 focus:ring-2 focus:ring-orange-300"
                        />
                        <label
                          htmlFor={`editInternal-${role.id}`}
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="flex items-center justify-between">
                        <Badge
                          className={` border font-bold text-sm px-3 py-1`}
                        >
                          {role.name}
                        </Badge>
