        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {promotions.map((promo, index) => {
              ...
              const accentColors = [
                {
                  bg: "from-[#78A243] to-[#DA7339]",
                  badge: "bg-[#78A243]/10 text-[#78A243] border-[#78A243]/30",
                  progress: "from-[#78A243] to-[#DA7339]",
                },
                {
                  bg: "from-[#DA7339] to-[#EBD187]",
                  badge: "bg-[#DA7339]/10 text-[#DA7339] border-[#DA7339]/30",
                  progress: "from-[#DA7339] to-[#EBD187]",
                },
                {
                  bg: "from-[#78A243] to-[#EBD187]",
                  badge: "bg-[#EBD187]/30 text-[#78A243] border-[#78A243]/30",
                  progress: "from-[#78A243] to-[#EBD187]",
                },
                {
                  bg: "from-[#DA7339] to-[#78A243]",
                  badge: "bg-[#DA7339]/10 text-[#2D1E1A] border-[#DA7339]/30",
                  progress: "from-[#DA7339] to-[#78A243]",
                },
              ];
              ...
              return (
                <Card
                  key={promo.id}
                  className="relative overflow-hidden p-4 bg-white border-2 border-[#78A243]/20 shadow-sm hover:shadow-lg hover:border-[#78A243] transition-all duration-300 rounded-xl group"
                >
                  {/* Gradient overlay */}
                  <div
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <div
                          className={`w-8 h-8 bg-gradient-to-br ${colors.bg} rounded-lg flex items-center justify-center shadow-md group-hover:scale-110 transition-all`}
                        >
                          <Gift
                            size={16}
                    ...
                    <span
                      className={`inline-flex items-center gap-1 text-xs px-2 py-1 rounded-lg font-bold border ${
                        promo.status
                  ...
                  <div className="space-y-2 mb-3 p-3 bg-gradient-to-br from-gray-50 to-transparent rounded-lg border border-gray-100">
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-6 h-6 bg-gradient-to-br ${colors.bg} rounded-md flex items-center justify-center flex-shrink-0 shadow-sm`}
                      >
                        <Percent
                          size={12}
                          className="text-white"
