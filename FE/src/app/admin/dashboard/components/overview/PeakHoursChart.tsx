...
export default function PeakHoursChart({ data, isLoading }: PeakHoursChartProps) {
    ...
    return (
        <Card className="p-5 rounded-xl bg-gradient-to-br from-white/90 to-[#EBD187]/5 backdrop-blur-sm border-[#78A243]/20 border shadow-sm h-full">
            ...
            <p className="text-xs text-[#2D1E1A]/60 mb-5">Lượng đơn hàng trung bình theo giờ</p>
                ...
                {isLoading ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-xs text-[#2D1E1A]/50 mt-1">Dữ liệu khung giờ sẽ hiển thị tại đây</p>
                        </div>
                    </div>
                ) : (
                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                            <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#78A243" strokeOpacity={0.15} />
                            <XAxis
                                dataKey="hour"
                                axisLine={false}
                                tickLine={false}
