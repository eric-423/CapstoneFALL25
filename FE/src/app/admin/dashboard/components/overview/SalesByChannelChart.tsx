...
function SalesByChannelChart({ data, isLoading }: SalesByChannelChartProps) {
  ...
  return (
    <Card className="p-5 rounded-xl bg-white backdrop-blur-sm border-grey-300 border shadow-sm h-full flex flex-col">
      ...
      <p className="text-xs text-[#2D1E1A]/60 mb-2">
        Phân bố theo kênh bán hàng
      </p>
        ...
        <div className="flex-1 min-h-[200px] flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xs text-[#2D1E1A]/50 mt-1">
              Dữ liệu doanh thu sẽ hiển thị tại đây
            </p>
          </div>
        </div>
      ) : (
        <div className="flex-1 flex flex-col min-h-0">
          <div className="flex-1 min-h-[180px] relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-xs text-[#2D1E1A]/60 font-medium">
                Tổng
              </span>
