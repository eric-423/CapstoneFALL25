                ...
                {isLoading ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-sm font-medium text-[#2D1E1A]/70">Chưa có dữ liệu doanh thu</p>
                            <p className="text-xs text-[#2D1E1A]/50 mt-1">Thay đổi bộ lọc hoặc chờ dữ liệu mới</p>
                        </div>
                    </div>
                ) : (
