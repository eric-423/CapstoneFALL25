...
export function MaterialTypesManagerDialog({
  open,
  onOpenChange,
}: MaterialTypesManagerDialogProps) {
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Không thể xóa loại nguyên liệu!";
                    ...
                    {editingId === type.id ? (
                      <>
                        <input
                          ...
                          className="flex-grow px-2 py-1 border border-[#78A243] rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#78A243]"
                          autoFocus
                          onKeyDown={(e) =>
                            e.key === "Enter" && handleSaveUpdate(type.id)
                          }
                        />
                        <div className="flex gap-2 ml-2">
                          <Button
                            onClick={() => handleSaveUpdate(type.id)}
                            size="sm"
                            className="h-8 w-8 p-0 bg-[#78A243] hover:bg-[#78A243]/90"
                      ...
                      <>
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            variant="outline"
                            className="h-8 w-8 p-0"
                            disabled={actionLoading || editingId !== null}
                          >
            ...
            {isCreating ? (
              <div className="space-y-2">
                <input
                  ...
                  className="w-full px-3 py-2 border border-[#78A243] rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#78A243]"
                  autoFocus
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    className="flex-1 bg-[#78A243] hover:bg-[#78A243]/90"
                    disabled={actionLoading}
                  >
                    {" "}
              ...
              <Button
                ...
                className="w-full bg-[#78A243] hover:bg-[#78A243]/90 text-white"
