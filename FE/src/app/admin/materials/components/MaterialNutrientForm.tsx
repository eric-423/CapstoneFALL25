...
export function MaterialNutrientForm({
    ...
    const handleChange = (index: number, field: keyof NutrientRow, value: string) => {
        setRows((prev) => {
            const next = [...prev];
                                ...
                                >
                                    <div className="space-y-1">
                                        ...
                                        <AdminSelect
                                            ...
                                            onValueChange={(value) => handleChange(index, "nutrientId", value)}
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <Input
                                                ...
                                                onChange={(e) =>
                                                    handleChange(index, "amountPer100Unit", e.target.value)
                                                }
                                                placeholder="0"
