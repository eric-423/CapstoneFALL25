                      ...
                      <>
                        <div className="flex-grow flex gap-2">
                          <input
                            ...
                            autoFocus
                            onKeyDown={(e) =>
                              e.key === "Enter" && handleSaveUpdate(unit.id)
                            }
                          />
                          <input
                            type="text"
                        ...
                        <div className="flex gap-2 ml-2">
                          <Button
                            onClick={() => handleSaveUpdate(unit.id)}
                            size="sm"
