            ...
            <Card className="w-full max-w-lg bg-white shadow-2xl rounded-2xl border-0 overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto">
                    <div className="space-y-4">
                        ...
                        {/* Mã dinh dưỡng */}
                        <div className="space-y-1.5">
                            <Label htmlFor="code" className="text-xs font-semibold text-[#2D1E1A] flex items-center gap-1">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            {/* Năng lượng */}
                            <div className="space-y-1.5">
                                <Label htmlFor="energyPerUnit" className="text-xs font-semibold text-[#2D1E1A] flex items-center gap-1">
