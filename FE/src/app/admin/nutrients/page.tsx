...
export default function NutrientsPage() {
  ...
  const [deletingNutrient, setDeletingNutrient] = useState<Nutrient | null>(
    null
  );
  ...
  return (
    <AdminPageLayout>
        ...
        {nutrients.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <p className="text-[#2D1E1A]/70">
              Không tìm thấy dữ liệu dinh dưỡng
            </p>
          </div>
        )}
      ...
      <ConfirmDialog
        ...
        content={
          <span>
            Bạn có chắc chắn muốn xóa dinh dưỡng{" "}
            <span className="font-bold text-gray-900">
              {deletingNutrient?.name}
            </span>
            ?
          </span>
        }
