      ...
      <Card className="w-full max-w-md bg-white shadow-2xl rounded-2xl overflow-hidden py-0">
        <div className="bg-[#78A243] p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-white">Sửa nguyên liệu</h2>
            <button
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-6 pb-6 space-y-5">
            <div className="items-center gap-3 p-4 bg-[#78A243]/10 rounded-xl">
              <div>
                <p className="font-bold text-[#2D1E1A]">
