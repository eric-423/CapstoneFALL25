                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                        {orderStatuses.map((status) => (
                            <Button
                                ...
                                className={`transition-all duration-300 rounded-xl font-semibold ${selectedStatus === status
                                    ? 'bg-gradient-to-r from-[#EC6426] to-[#F8A91F] text-white border-0 shadow-md'
                                    : 'border-2 border-gray-300 text-gray-700 hover:border-[#EC6426] hover:text-[#EC6426]'
                                    }`}
                            >
