...
const MenuItem = memo(({
    ...
    return (
        ...
        >
            <div className="relative flex items-center" style={{ minHeight: '48px' }}>
                {/* Tree Structure - Only when expanded */}
                {!isCollapsed && (
                    <>
                        {/* Vertical Line - Continuous through all items */}
                        <div className={`
                        ...
                        {/* Horizontal connecting line to the menu item */}
                        <div className="absolute left-[15px] top-1/2 w-[20px] h-[2px] bg-white/30"></div>

                        {/* Node Circle - Static small dots for inactive items */}
                        {!isActive && (
        ...
        <AdminProvider>
            ...
            <div className="min-h-screen bg-[#EFE6DB]">
                ...
                <div className="flex relative">
                    ...
                    `}>
                        {/* Header */}
                        <div className="relative p-5 border-b border-white/20 flex-shrink-0 flex items-center overflow-hidden">
                            ...
                            {!isCollapsed && (
                                <div className="relative z-10 ml-3 flex-1 min-w-0 transition-opacity duration-150">
                                    <h2 className="font-black text-lg text-white drop-shadow-lg tracking-wide truncate">
                                        TamTech
                                    </h2>
                                    <p className="text-[10px] text-white/80 font-semibold tracking-widest uppercase">
                                        Admin Panel
                                    </p>
                                </div>
                            )}
                        ...
                        <div className="p-3 sm:p-4 flex-shrink-0 border-t border-white/20">
                            ...
                            >
                                ...
                                {!isCollapsed && <span className="text-sm sm:text-base font-semibold">Đăng xuất</span>}
                            </Button>
                        </div>
                    </aside>

                    {/* Main Content */}
                    <main className={`flex-1 w-full bg-[#EFE6DB] min-w-0 transition-[margin] duration-200 ease-out will-change-[margin] ${isCollapsed ? 'lg:ml-20' : 'lg:ml-56 xl:ml-64'}`}>
                        {/* Mobile Menu Toggle */}
