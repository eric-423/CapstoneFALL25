...
export function ProductDragOverlay({ product }: ProductDragOverlayProps) {
    return (
        <div className="flex items-center gap-3 p-3 bg-white border-2 border-orange-500 shadow-xl rounded-lg w-[300px] cursor-grabbing opacity-90">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-orange-600 font-medium">{product.productPrice.toLocaleString()}đ</p>
            </div>
        </div>
    );
}
