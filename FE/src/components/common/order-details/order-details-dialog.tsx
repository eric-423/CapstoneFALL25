...
export function OrderDetailsDialog({ order, open, onClose, isLoading = false }: OrderDetailsDialogProps) {
    const { isCancelingOrder } = useCustomerOrders({ realtime: false });
    ...
    return (
        <>
            <Dialog open={open} onOpenChange={(isOpen) => {
                ...
                {isCancelingOrder ? (
                    <DialogContent className='max-w-[95vw] sm:max-w-[90vw] lg:max-w-[80rem] w-full max-h-[90vh] overflow-y-auto z-[100]'>
                    ...
                    <>
                        <DialogContent className='max-w-[95vw] sm:max-w-[90vw] lg:max-w-[80rem] w-full max-h-[90vh] overflow-y-auto z-[100] py-12 px-7'>
                            {isLoading && (
