...
const LatestOrders = () => {
  ...
  return (
    <Card
      title={<span style={{ fontWeight: 700, fontSize: 20 }}>Đơn hàng mới nhất</span>}
      style={{
        borderRadius: 16,
        border: 'none',
        marginBottom: 30,
      ...
      <Modal
        ...
        footer={[
          <Button
            ...
            style={{ borderRadius: 6, borderColor: '#D97B41', color: '#D97B41', outline: 'none', border: '#D' }}
          >
            Đóng
          </Button>,
        ]}
          ...
          >
            ...
            >
              ...
              <Descriptions.Item label='Ngày đặt'>
                {dayjs(selectedOrder.order_create_at).format('DD/MM/YYYY HH:mm:ss')}
              </Descriptions.Item>
