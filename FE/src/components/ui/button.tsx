...
function Button({
  ...
  // Don't force dark text color - let it inherit from parent context
  return <Comp data-slot='button' className={cn(buttonVariants({ variant, size, className }))} style={style} {...props} />;
}
