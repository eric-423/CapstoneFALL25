...
const BG_MAIN = '#FFF6E3';
const BG_CARD = '#fff';
const COLOR_ACCENT = '#F4A259'; // cam nhạt
const COLOR_ACCENT_DARK = '#E1701A'; // cam đậm
const COLOR_USER = '#D97B41'; // xanh dương cho user
const COLOR_ADMIN = '#F4F4F4'; // xám nhạt cho admin
const COLOR_TEXT = '#333';
const COLOR_TEXT_SECONDARY = '#D97B41';
        ...
        <Grid container spacing={3}>
                ...
                <TextField
                  ...
                  sx={{
                    ...
                    '& .MuiOutlinedInput-root': {
                      borderRadius: 2,
                      '& fieldset': {
                        borderColor: '#ccc', // viền xám mặc định
                      },
                      '&:hover fieldset': {
                        borderColor: '#D97B41', // hover viền cam nâu
                      },
                      '&.Mui-focused fieldset': {
                        borderColor: '#D97B41', // focus viền cam nâu
                        borderWidth: 2,
                      },
                    },
                  }}
                  ...
                  {chats.map((chat) => (
                    <React.Fragment key={chat.id}>
                      <ListItem
                        ...
                        sx={{
                          cursor: 'pointer',
                          bgcolor: selectedChat === chat.id ? '#FFE5C2' : 'inherit',
                          borderRadius: 2,
                          mx: 1,
                          mb: 1,
                          boxShadow: selectedChat === chat.id ? '0 2px 8px #F4A25933' : 'none',
                          transition: 'all 0.2s',
                          '&:hover': {
                            bgcolor: '#FFF0D9',
                          },
          ...
          <Grid item xs={12} md={8}>
            <Paper elevation={3} sx={{ p: 0, height: '80vh', borderRadius: 3, boxShadow: '0 2px 12px #0001', display: 'flex', flexDirection: 'column', background: BG_CARD }}>
              ...
              {/* Input */}
              <Box sx={{ p: 2, borderTop: '1px solid #F4F4F4', background: '#FAFAFA', borderRadius: '0 0 20px 20px', display: 'flex', alignItems: 'center', gap: 1 }}>
                <TextField
                  fullWidth
                  variant="outlined"
